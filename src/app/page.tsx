...
const projects = [
  {
    ...
    techstack: [ // <-- Add paths to tech stack icons for Procrash
        '/techstack/rust-svgrepo-com.svg',
  ...
  },
  {
    ...
    description: 'Graphics & Algorithms',
    techstack: [
        '/techstack/rust-svgrepo-com.svg',
    ],
    imageSrc: '/proj/raytracing-in-rust.png',
  ...
  },
  {
    ...
    techstack: [
        '/techstack/go-svgrepo-com.svg',
        '/techstack/linux-svgrepo-com.svg',
    ],
...
const devSkills = [
  'Go', 'Rust', 'C', 'Python', 'JavaScript', 'TypeScript',
  'HTML', 'CSS', 'Bash', 'SQLite',  'MySQL',
  'React', 'Vue.js', 'Next.js', 'Nuxt.js', 'Tailwind', 'Node.js',
  'GraphQL', 'REST APIs', 'WebSockets',
  'Docker', 'Linux', 'Git', 'GitHub', 'VS Code',
  'SDL2', 'Bevy', 'Flutterflow', 'Firebase', 'Pocketbase',
  'Springboot', 'Postman', 'GDB', 'JWT', 'OAuth'
];
    ...
    <> {/* Added React Fragment wrapper */}
      ...
      <main className="flex-grow flex flex-col items-center h-full relative pt-20"> {/* Added padding top to account for fixed header */}
        ...
        <div className="font-bold text-center opacity-0 animate-fadeIn mt-1 md:mt-3">
          <TrueFocus
            sentence="Developer   Creator   Cybersecurity-specialist"
            manualMode={true}
            blurAmount={5}
            borderColor="cyan"
          ...
          {/* Tech Stack Section Start */}
             ...
             <div className="relative p-6 rounded-lg transition-transform duration-300 ease-in-out hover:scale-105 custom-corner-border">
               ...
               <p className="text-gray-400 md:text-md text-sm mt-2 leading-relaxed mb-5">
                   Développeur passionné, je conçois des solutions modernes, performantes et adaptées aux besoins. curieux et rigoureux, j&rsquo;aime apprendre, collaborer et relever des défis techniques avec créativité.
               </p>
             ...
             <div className="relative p-6 rounded-lg transition-transform duration-300 ease-in-out hover:scale-105 custom-corner-border">
               ...
               <p className="text-gray-400 md:text-md text-sm mt-2 leading-relaxed mb-5">
                Passionné par la Cybersécurité, je m&rsquo;engage à protéger les systèmes et les données en anticipant les menaces et en proposant des solutions fiables. j&rsquo;aime analyser, comprendre et sécuriser chaque maillon de la chaine.
               </p>
               <h4 className="text-cyan-300 font-semibold mb-3 text-base">
                 Skillset &amp; Tools
               </h4>
      ...
      <footer className="flex w-full items-center justify-center p-4 border-t border-white/[.15] text-white/50 text-sm font-light mt-20"> {/* Added margin top */}
        <p>&copy; {new Date().getFullYear()} DAIBOU BA. All rights reserved.</p> {/* Updated name */}
      </footer>
