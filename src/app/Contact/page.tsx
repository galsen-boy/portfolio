...
const socialLinks = [
    { platform: "GitHub", href: "https://github.com/galsen-boy", iconPath: "/icons/github_icon.svg" }, // <-- Replace YOUR_GITHUB_LINK and icon path
    { platform: "LinkedIn", href: "https://www.linkedin.com/in/daibou-ba-b99880298/", iconPath: "/icons/linkedin_icon.svg" }, // <-- Replace YOUR_LINKEDIN_LINK and icon path
    { platform: "Gmail", href: "mailto:badaibou5@gmail.com", iconPath: "/icons/gmail_icon.svg" }, // <-- Replace YOUR_EMAIL_ADDRESS and icon path
];

// Define contact information
const contactInfo = {
    email: "badaibou5@gmail.com",
};
